...
def cli():
    ...
    parser.add_argument("ifname", type=str, default="eth0", help="Network interface name to get the IP from (default: eth0)")
    parser.add_argument("record_name", type=str, default="example.com", help="DNS record name to update (default: example.com)")
    parser.add_argument("zone_id", type=str, default="", help="Cloudflare zone ID (default: empty)")
    parser.add_argument("dns_record_id", type=str, default="", help="DNS record ID to update (default: empty)")
    parser.add_argument("bearer_token", type=str, default="", help="Cloudflare API bearer token (default: empty)")
